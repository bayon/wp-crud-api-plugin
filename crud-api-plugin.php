...
function custom_files(){
    ...
    //~
   // wp_enqueue_script('crud-api-plugin-js', get_theme_file_uri('/js/crud-api-plugin.js'), NULL, '1.0', true);
...
////////////////////////////////////////////////////
function crud_api_plugin_shortcode() {
	include_once(plugin_dir_path( __FILE__ ).'crud-api-plugin-page.php');
}
add_shortcode( 'crud_api_plugin', 'crud_api_plugin_shortcode' );
